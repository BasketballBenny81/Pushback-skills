...
void left_auton() {
  ...
  chassis.moveToPoint(-32, 5, 1000);
	...
	chassis.moveToPoint(-32, -34, 1500, {.maxSpeed = 60});
	pros::delay(1000);
...
void right_auton() {
  ...
  chassis.moveToPoint(34, -38, 1000, {.maxSpeed = 60});
  pros::delay(700);
...
void skills75_auton() {
  ...
  intake_move(12000);
  intakelift.set_value(true);
  chassis.turnToPoint(32, 5, 500, {.forwards = false});
  chassis.moveToPoint(32, 5, 1500, {.forwards = false});
  intakelift.set_value(true);
  ...
  stopper.set_value(false);
  bar.set_value(true);
  chassis.moveToPoint(37, 140, 1000, {.maxSpeed = 60});
  chassis.moveToPoint(37, 140, 1000, {.maxSpeed = 40});
  pros::delay(2000);
  chassis.moveToPoint(37, 65, 1000, {.forwards = false, .maxSpeed = 60});
  chassis.moveToPoint(37, 65, 1000, {.forwards = false, .maxSpeed = 60});
  bar.set_value(false);
   pros::delay(750);
  stopper.set_value(true);
  ...
  chassis.turnToPoint(-128, -70, 500, {.forwards = false});
  chassis.moveToPoint(-128, -70, 1000, {.forwards = false}); 
  chassis.turnToPoint(-126, -50, 500, {.forwards = false});
  chassis.moveToPoint(-126, -50, 1000, {.forwards = false});
  pros::delay(750);
  stopper.set_value(true);
  pros::delay(2000);
  bar.set_value(true);
  chassis.moveToPoint(-126, -124, 1000);
  // stopper.set_value(true);
  // pros::delay(1000);
  // stopper.set_value(false);
