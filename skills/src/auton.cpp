...
void skills_auton() {
  ...
  outtake.move_voltage(12000); 
  chassis.turnToPoint(44, 0,800);
  chassis.moveToPoint(44, 0, 1000);
  chassis.moveToPoint(46, 0, 300);
  chassis.turnToPoint(46, 30, 700);
  bar.set_value(true);
  chassis.moveToPoint(46, 30, 1000, {.maxSpeed = 90});
  chassis.moveToPoint(46, 34, 300);
  pros::delay(2000);
  chassis.turnToPoint(75, 5,300, {.forwards = false});
  chassis.moveToPoint(75, 5, 800, {.forwards = false});
  bar.set_value(false);
  wing.set_value(true);
  chassis.turnToPoint(80, -80,300, {.forwards = false});
  chassis.moveToPoint(80, -80, 2000, {.forwards = false});
  chassis.turnToHeading(-90, 1000);
  chassis.turnToPoint(55, -80,1000);
  chassis.moveToPoint(55, -80, 1000);
  ...
  bar.set_value(true);
  chassis.turnToPoint(55, -130, 400);
  chassis.moveToPoint(55, -130, 1000, {.maxSpeed = 90});
  chassis.moveToPoint(55, -130, 400);
  pros::delay(2000);
  ...
  chassis.setPose(0,0,0);
  stopper.set_value(false);
  chassis.turnToPoint(40,60,500);
  chassis.moveToPoint(40,60,1000);
  chassis.turnToHeading(77, 1000);
  bar.set_value(true);
  midgoaldescore.set_value(true);
  chassis.moveToPoint(80, 60, 2000);
  bar.set_value(false);
  chassis.turnToPoint(80, 10, 500);
  chassis.moveToPoint(80, 10, 1300);
  chassis.turnToHeading(0, 1000);
  chassis.moveToPoint(80,-10,800,{.forwards = false});
  pros::delay(1000);
  stopper.set_value(true);
  pros::delay(2000);
