...
void skills_auton() {
  ...
  chassis.turnToPoint(0, 18,1000, {.maxSpeed = 40});
  ...
  chassis.turnToPoint(52, 30, 500);
  bar.set_value(true);
  chassis.moveToPoint(52, 30, 1000, {.maxSpeed = 90});
  chassis.moveToPoint(52, 34, 300);
  pros::delay(2000);
  chassis.turnToPoint(75, -5,1000, {.forwards = false});
  chassis.moveToPoint(75, -5, 2000, {.forwards = false});
  bar.set_value(false);
  wing.set_value(true);
  chassis.turnToPoint(80, -75,1000, {.forwards = false});
  chassis.moveToPoint(80, -75, 2000, {.forwards = false});
  chassis.turnToHeading(-90, 1000);
  chassis.turnToPoint(60, -75,500);
  chassis.moveToPoint(60, -75, 2000);
  chassis.turnToHeading(180, 1000);
  chassis.moveToPoint(60, -50, 2000, {.forwards = false});
  pros::delay(900);
  ...
  chassis.moveToPoint(60, -130, 2000, {.maxSpeed = 90});
  chassis.moveToPoint(60, -130, 400);
  pros::delay(2000);
  chassis.moveToPoint(60, -50, 2000, {.forwards = false, .maxSpeed = 90});
  pros::delay(1000);
  stopper.set_value(true);
  pros::delay(2000);
  chassis.setPose(0,0,0);
