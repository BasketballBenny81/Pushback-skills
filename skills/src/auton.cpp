...
void skills_auton() {
  ...
  chassis.turnToPoint(0, 10,200, {.maxSpeed = 40});
  chassis.moveToPoint(0, 10,600, {.maxSpeed = 40});
  chassis.setPose({0, 0, 0});
  ...
  outtake.move_voltage(12000); 
  chassis.turnToPoint(42, 0,800);
  chassis.moveToPoint(42, 0, 1000);
  chassis.moveToPoint(44, 0, 300);
  chassis.turnToPoint(44, 30, 700);
  bar.set_value(true);
  chassis.moveToPoint(44, 30, 1000, {.maxSpeed = 90});
  chassis.moveToPoint(44, 34, 300);
  pros::delay(2000);
  ...
  chassis.turnToPoint(55, -70,1000);
  chassis.moveToPoint(55, -70, 1000);
  ...
  bar.set_value(true);
  chassis.turnToPoint(57, -130, 400);
  chassis.moveToPoint(57, -130, 1000);
  chassis.moveToPoint(57, -130, 400);
  pros::delay(2000);
  chassis.moveToPoint(55, -50, 1000, {.forwards = false, .maxSpeed = 60});
  pros::delay(1000);
  stopper.set_value(true);
  pros::delay(2000);
  bar.set_value(false);
  chassis.setPose(0,0,0);
    chassis.moveToPoint(0, 13, 800);
  stopper.set_value(false);
  chassis.turnToPoint(95, 13, 500);
  chassis.moveToPoint(95, 13, 2000);
  chassis.turnToPoint(95, 48, 500);
  bar.set_value(true);
  chassis.moveToPoint(95, 48, 1000, {.maxSpeed = 60});
  chassis.moveToPoint(95, 45, 400, {.maxSpeed = 60});
  pros::delay(2000);
  chassis.turnToPoint(110, 0, 500, {.forwards = false});
  chassis.moveToPoint(110, 0, 800, {.forwards = false});
  bar.set_value(false);
  chassis.turnToPoint(110, -70, 500, {.forwards = false});
  chassis.moveToPoint(110, -65, 2000, {.forwards = false});
  chassis.turnToHeading(-90, 1000);  
  chassis.moveToPoint(98, -65, 1000); 
  chassis.turnToHeading(180, 1000);
  chassis.moveToPoint(98, -50, 1000, {.forwards = false});
  pros::delay(750);
  stopper.set_value(true);
  pros::delay(2000);
  stopper.set_value(false);
  bar.set_value(true);
  chassis.moveToPoint(98, -124, 1500);
  chassis.moveToPoint(98, -124, 500);
  pros::delay(2000);
  chassis.moveToPoint(98, -60, 1100, {.forwards = false}); 
  pros::delay(750);
  stopper.set_value(true);
  pros::delay(2000); 
  chassis.setPose({0, 0, 0});
